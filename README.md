...
Once done add config to use our test Kubernetes cluster into `~/.kube/config` ([download](https://github.com/Veriff/k8s-workshop/raw/vrf-katlin/kubectl-config)). 
...
- name: k8s-workshop--user
  user:
    token: eyJhbGciOiJSUzI1NiIsImtpZCI6IjZSMHhwYm1LN3d2Sk1RUUJFaXhOQ2JqZEJocDZsc1JkYmZhM2czZUxhVm8ifQ..6CyDqr-2boDfyxK6YqPjbkolLszF1nvhDGJVoUndEPvyLMWqY8N_OYjxZ9KjOoc_SzJ0e3HdyHyhVfIqnBs0CjYm7KkTqbrHEAx4UaaKsHbF4bY_4-FJEgmsN6wyV9AIzSTqtZ8KeMZ1OuSmZMbsca0PsasPdFSpjwKFOimgIeQVoaRluiXSUVS_bdgpNwYCfXNgL5KKiKqg_NzJWw91-TGEOt5wzzJ8j3OfsbPH9flFQXVc_te19U92NO-c5AsMiJv4zgbebHgvEQUp6-W0FhJmwYEa__lNQWIPwoFEvtLFSwFNIblpzGluKUeYdKVQp_KEdxpifJyxEKEAYNoW8g
contexts:
# context is what you use - it describes for this cluster use this auth 
- context:
    cluster: k8s-workshop--cluster
    user: k8s-workshop--user
    namespace: vrf-katlin
  name: k8s-workshop
...
```sh
kubectl --context=k8s-workshop -n vrf-katlin auth can-i list pods
# should return yes
```
...
> `kubectl --context=k8s-workshop -n vrf-katlin apply -f examples/pod.yml`
```yaml
---
apiVersion: v1
kind: Pod
...
For testing, get list of pods in your namespace (`-n=vrf-katlin`)
```sh
# list all pods in your namespace
kubectl --context=k8s-workshop -n=vrf-katlin get pods -o wide
```
...
```sh
# show declaration
kubectl --context=k8s-workshop -n=vrf-katlin get pod/pod-example -o yaml

# describe pod
kubectl --context=k8s-workshop -n=vrf-katlin describe pod/pod-example
```

If you want to delete the resource, use `kubectl delete`
```sh
# delete all resources from file
kubectl --context=k8s-workshop -n=vrf-katlin delete -f examples/pod.yml

# or delete by name
kubectl --context=k8s-workshop -n=vrf-katlin delete pod/pod-example
```
...
> `kubectl --context=k8s-workshop -n vrf-katlin apply -f examples/deployment.yml`
```yaml
---
apiVersion: apps/v1
kind: Deployment
...
kubectl --context=k8s-workshop -n=vrf-katlin get deployments

# get list of pods
kubectl --context=k8s-workshop -n=vrf-katlin get pods -o wide

# get deploy-example pods (-l is label selector, you can give it to all resource calls)
kubectl --context=k8s-workshop -n=vrf-katlin get pods -l=app=deploy-example

# get all pods using shared purpose=training label selector
kubectl --context=k8s-workshop -n=vrf-katlin get pods -l=purpose=training

# show labels in output (-L)
kubectl --context=k8s-workshop -n=vrf-katlin get pods -L=purpose,app
...
# connect into pod
kubectl --context=k8s-workshop -n=vrf-katlin exec -it deployment/deploy-example -- sh
kubectl --context=k8s-workshop -n=vrf-katlin exec -it <POD_NAME> sh

# show logs from pod
kubectl --context=k8s-workshop -n=vrf-katlin logs -f --tail=20 -l=app=deploy-example
kubectl --context=k8s-workshop -n=vrf-katlin logs -f --tail=20 <POD_NAME>
...
# get list of pods
kubectl --context=k8s-workshop -n=vrf-katlin get pods 
# delete one pod
kubectl --context=k8s-workshop -n=vrf-katlin delete pod <POD_NAME>
...
> `kubectl --context=k8s-workshop -n vrf-katlin apply -f examples/service.yml`
```yaml
---
apiVersion: v1
kind: Service
...
kubectl --context=k8s-workshop -n=vrf-katlin get services
...
```sh
# connnect to pod
kubectl --context=k8s-workshop -n=vrf-katlin exec -it deployment/deploy-example -- bash
...
> `kubectl --context=k8s-workshop -n vrf-katlin apply -f examples/ingress.yml`
```yaml
---
...
spec:
  ...
  rules:
  # https://vrf-katlin.k8s.vrfgstest.org/
  - host: "vrf-katlin.k8s.vrfgstest.org"
    http:
      paths:
      - pathType: Prefix
        path: "/"
...
And try to access your app using [https://vrf-katlin.k8s.vrfgstest.org/](https://vrf-katlin.k8s.vrfgstest.org/).

```sh
# get list of ingress
kubectl --context=k8s-workshop -n=vrf-katlin get ingress
