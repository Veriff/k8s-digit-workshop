...
Once done add config to use our test Kubernetes cluster into `~/.kube/config` ([download](https://github.com/Veriff/k8s-workshop/raw/vrf-cat-was-here/kubectl-config)). 
...
# cluster info
- cluster:
    certificate-authority-data: 
    server: https://2ACFDDBA5C247314B8ACDC7CF72AF87E.sk1.eu-west-1.eks.amazonaws.com
  name: k8s-workshop--cluster
users:
# auth info
- name: k8s-workshop--user
  user:
    token: eyJhbGciOiJSUzI1NiIsImtpZCI6IjZSMHhwYm1LN3d2Sk1RUUJFaXhOQ2JqZEJocDZsc1JkYmZhM2czZUxhVm8ifQ..O-5ZKQtkGjB9_cJHLiQ4dB13zWFhToaXQKk01Hc-RZpiucuttg9lClmqrN6vKQ9ez8YrlWjE47-BDxG49QvjbwsJMG-hWw5o8kNaaQmb3k2F8RWK3maMKOS5dk9yH4E5T0YZQArLzpimmbwRCCAGTVBEysPhbajJkB4uUpWEfkyQ8jeTtM2ogGkBC_61rgbGuy1sPJdza_812W_lGWb9wFQaefekFlk2Xur5kNZcpc2bLVXiBHIrZgFrgvIG2zygNfiKNkN2Cb4TZeSBFBw9TtmgsS2O0TUDdFJSt9cME2d_rpc9l5oMQbGlhCo2TCrh90T4-qxPOj8w70ZM-mJf4g
contexts:
# context is what you use - it describes for this cluster use this auth 
- context:
    cluster: k8s-workshop--cluster
    user: k8s-workshop--user
    namespace: vrf-cat-was-here
  name: k8s-workshop
```
...
```sh
kubectl --context=k8s-workshop -n vrf-cat-was-here auth can-i list pods
# should return yes
```
...
# use your branch
git checkout k8s-workshop-2022/vrf-cat-was-here
```
...
> `kubectl --context=k8s-workshop -n vrf-cat-was-here apply -f examples/pod.yml`
```yaml
---
apiVersion: v1
kind: Pod
...
For testing, get list of pods in your namespace (`-n=vrf-cat-was-here`)
```sh
# list all pods in your namespace
kubectl --context=k8s-workshop -n=vrf-cat-was-here get pods -o wide
```
...
```sh
# show declaration
kubectl --context=k8s-workshop -n=vrf-cat-was-here get pod/pod-example -o yaml

# describe pod
kubectl --context=k8s-workshop -n=vrf-cat-was-here describe pod/pod-example
```

If you want to delete the resource, use `kubectl delete`
```sh
# delete all resources from file
kubectl --context=k8s-workshop -n=vrf-cat-was-here delete -f examples/pod.yml

# or delete by name
kubectl --context=k8s-workshop -n=vrf-cat-was-here delete pod/pod-example
```
...
> `kubectl --context=k8s-workshop -n vrf-cat-was-here apply -f examples/deployment.yml`
```yaml
---
apiVersion: apps/v1
kind: Deployment
...
kubectl --context=k8s-workshop -n=vrf-cat-was-here get deployments

# get list of pods
kubectl --context=k8s-workshop -n=vrf-cat-was-here get pods -o wide

# get deploy-example pods (-l is label selector, you can give it to all resource calls)
kubectl --context=k8s-workshop -n=vrf-cat-was-here get pods -l=app=deploy-example

# get all pods using shared purpose=training label selector
kubectl --context=k8s-workshop -n=vrf-cat-was-here get pods -l=purpose=training

# show labels in output (-L)
kubectl --context=k8s-workshop -n=vrf-cat-was-here get pods -L=purpose,app
...
# connect into pod
kubectl --context=k8s-workshop -n=vrf-cat-was-here exec -it deployment/deploy-example -- sh
kubectl --context=k8s-workshop -n=vrf-cat-was-here exec -it <POD_NAME> sh

# show logs from pod
kubectl --context=k8s-workshop -n=vrf-cat-was-here logs -f --tail=20 -l=app=deploy-example
kubectl --context=k8s-workshop -n=vrf-cat-was-here logs -f --tail=20 <POD_NAME>
...
# get list of pods
kubectl --context=k8s-workshop -n=vrf-cat-was-here get pods 
# delete one pod
kubectl --context=k8s-workshop -n=vrf-cat-was-here delete pod <POD_NAME>
...
> `kubectl --context=k8s-workshop -n vrf-cat-was-here apply -f examples/service.yml`
```yaml
---
apiVersion: v1
kind: Service
...
kubectl --context=k8s-workshop -n=vrf-cat-was-here get services
...
```sh
# connnect to pod
kubectl --context=k8s-workshop -n=vrf-cat-was-here exec -it deployment/deploy-example -- bash
...
> `kubectl --context=k8s-workshop -n vrf-cat-was-here apply -f examples/ingress.yml`
```yaml
---
...
spec:
  ...
  rules:
  # https://vrf-cat-was-here.playground.vrff.io/
  - host: "vrf-cat-was-here.playground.vrff.io"
    http:
      paths:
      - pathType: Prefix
        path: "/"
...
And try to access your app using [https://vrf-cat-was-here.playground.vrff.io/](https://vrf-cat-was-here.playground.vrff.io/).

```sh
# get list of ingress
kubectl --context=k8s-workshop -n=vrf-cat-was-here get ingress
