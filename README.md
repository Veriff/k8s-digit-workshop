...
Once done add config to use our test Kubernetes cluster into `~/.kube/config` ([download](https://github.com/Veriff/k8s-workshop/raw/asdfgasasf/kubectl-config)). 
...
- name: k8s-digit-workshop--user
  user:
    token: eyJhbGciOiJSUzI1NiIsImtpZCI6InV6dkF1NUN6U0tiLUplTUQtbXl0WHFZRU5INWxrLWdwbEVLLV9rTlAzZUEifQ..im8PCBSPQMQJFNNmMMM4pfhm5Gg13lJYVUD11L2TZ6otoycf8OR03FKHJs7Ja8Oys1WUnsQ9xr0nAYpIPC5ALCwrJof1ZGvKN2UYHAVxZVYk8gPojAhrq738Qr3zSBd29NwBhyUWLvNaiqVfHecaieG9TPsL2kv2iS7vbA3DyZIUh7awcmtXP_1his4Pco-G2moS-Y8APKZY2IdZUf67yFlguVicXdEJJjXjTjkCOPscA5VngSWvYeAErTMuXnVZu9eu1Ndp6Htl5Q-HRleet4xpX6bA9eYk7Yi9UwVLCeAJ1-Se-zGkmbErNkXjH1gLiQAwbFHYO7AYMKcbk0y9wA
contexts:
...
```sh
kubectl --context=k8s-digit-workshop -n asdfgasasf auth can-i list pods
```
...
> `kubectl --context=k8s-digit-workshop -n asdfgasasf apply -f examples/pod.yml`
```yaml
---
apiVersion: v1
kind: Pod
...
For testing, get list of pods in your namespace (`-n=asdfgasasf`)
```sh
# list all pods in your namespace
kubectl --context=k8s-digit-workshop -n=asdfgasasf get pods
```
...
```sh
# show declaration
kubectl --context=k8s-digit-workshop -n=asdfgasasf get pod/pod-example -o yaml

# describe pod
kubectl --context=k8s-digit-workshop -n=asdfgasasf describe pod/pod-example
```

If you want to delete the resource, use `kubectl delete`
```sh
# delete all resources from file
kubectl --context=k8s-digit-workshop -n=asdfgasasf delete -f examples/pod1.yml

# or delete by name
kubectl --context=k8s-digit-workshop -n=asdfgasasf delete pod/pod-example
```
...
> `kubectl --context=k8s-digit-workshop -n asdfgasasf apply -f examples/deployment.yml`
```yaml
---
apiVersion: apps/v1
kind: Deployment
...
kubectl --context=k8s-digit-workshop -n=asdfgasasf get deployments

# get list of pods
kubectl --context=k8s-digit-workshop -n=asdfgasasf get pods

# get deploy-example pods (-l is label selector, you can give it to all resource calls)
kubectl --context=k8s-digit-workshop -n=asdfgasasf get pods -l=app=deploy-example

# get all pods using shared purpose=training label selector
kubectl --context=k8s-digit-workshop -n=asdfgasasf get pods -l=purpose=training

# show labels in output (-L)
kubectl --context=k8s-digit-workshop -n=asdfgasasf get pods -L=purpose,app
...
# connect into pod
kubectl --context=k8s-digit-workshop -n=asdfgasasf exec -it deployment/deploy-example -- sh
kubectl --context=k8s-digit-workshop -n=asdfgasasf exec -it <POD_NAME> sh

# show logs from pod
kubectl --context=k8s-digit-workshop -n=asdfgasasf logs -f --tail=20 -l=app=deploy-example
kubectl --context=k8s-digit-workshop -n=asdfgasasf logs -f --tail=20 <POD_NAME>
...
kubectl --context=k8s-digit-workshop -n=asdfgasasf get pods 
# delete one pod
kubectl --context=k8s-digit-workshop -n=asdfgasasf delete pod <POD_NAME>
...
> `kubectl --context=k8s-digit-workshop -n asdfgasasf apply -f examples/service.yml`
```yaml
---
apiVersion: v1
kind: Service
...
kubectl --context=k8s-digit-workshop -n=asdfgasasf get services
...
```sh
# connnect to pod
kubectl --context=k8s-digit-workshop -n=asdfgasasf exec -it deployment/deploy-example -- bash
...
> `kubectl --context=k8s-digit-workshop -n asdfgasasf apply -f examples/ingress.yml`
```yaml
---
...
spec:
  ...
  rules:
  # https://asdfgasasf.digit.vrfgstest.org/
  - host: "asdfgasasf.digit.vrfgstest.org"
    http:
      paths:
      - pathType: Prefix
        path: "/"
...
And try to access your app using [https://asdfgasasf.digit.vrfgstest.org/](https://asdfgasasf.digit.vrfgstest.org/).

```sh
# get list of ingress
kubectl --context=k8s-digit-workshop -n=asdfgasasf get ingress
