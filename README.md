...
Once done add config to use our test Kubernetes cluster into `~/.kube/config` ([download](https://github.com/Veriff/k8s-workshop/raw/vrf-fooo-booo/kubectl-config)). 
...
- name: k8s-workshop--user
  user:
    token: eyJhbGciOiJSUzI1NiIsImtpZCI6IjZSMHhwYm1LN3d2Sk1RUUJFaXhOQ2JqZEJocDZsc1JkYmZhM2czZUxhVm8ifQ..h_SdZzOTQGxOltrLuNqVNR41tucT5to8VVFifN5_iyt01vPL1LhdNEK9XDAviS0dGYcDGZxvlC7D_uxPiQL2tCjMLtns35tU5zWu0pBJg_c2zUQQeeB9s5SSWMO5AvSGT_QdrrK-WI6d0FRxMnUGjz-CQIFZydcy1jsevQc3Y7sDHafHq8lQ4bJVHr8T4sWvjgnbvL3kLBIhqjk1Kdg_Z02AmZZaAAz5favcBkO580sc469Q3KE42g15GVK6XixEXD11TIIxSBwl6kxuFFhRp48gWvanbJeXgVhYNqXAE2T9gWfRuo9D69wVARfhFD3rlJbcZDb2UUunXx9v1DIr7w
contexts:
# context is what you use - it describes for this cluster use this auth 
- context:
    cluster: k8s-workshop--cluster
    user: k8s-workshop--user
    namespace: vrf-fooo-booo
  name: k8s-workshop
...
```sh
kubectl --context=k8s-workshop -n vrf-fooo-booo auth can-i list pods
# should return yes
```
...
> `kubectl --context=k8s-workshop -n vrf-fooo-booo apply -f examples/pod.yml`
```yaml
---
apiVersion: v1
kind: Pod
...
For testing, get list of pods in your namespace (`-n=vrf-fooo-booo`)
```sh
# list all pods in your namespace
kubectl --context=k8s-workshop -n=vrf-fooo-booo get pods -o wide
```
...
```sh
# show declaration
kubectl --context=k8s-workshop -n=vrf-fooo-booo get pod/pod-example -o yaml

# describe pod
kubectl --context=k8s-workshop -n=vrf-fooo-booo describe pod/pod-example
```

If you want to delete the resource, use `kubectl delete`
```sh
# delete all resources from file
kubectl --context=k8s-workshop -n=vrf-fooo-booo delete -f examples/pod.yml

# or delete by name
kubectl --context=k8s-workshop -n=vrf-fooo-booo delete pod/pod-example
```
...
> `kubectl --context=k8s-workshop -n vrf-fooo-booo apply -f examples/deployment.yml`
```yaml
---
apiVersion: apps/v1
kind: Deployment
...
kubectl --context=k8s-workshop -n=vrf-fooo-booo get deployments

# get list of pods
kubectl --context=k8s-workshop -n=vrf-fooo-booo get pods -o wide

# get deploy-example pods (-l is label selector, you can give it to all resource calls)
kubectl --context=k8s-workshop -n=vrf-fooo-booo get pods -l=app=deploy-example

# get all pods using shared purpose=training label selector
kubectl --context=k8s-workshop -n=vrf-fooo-booo get pods -l=purpose=training

# show labels in output (-L)
kubectl --context=k8s-workshop -n=vrf-fooo-booo get pods -L=purpose,app
...
# connect into pod
kubectl --context=k8s-workshop -n=vrf-fooo-booo exec -it deployment/deploy-example -- sh
kubectl --context=k8s-workshop -n=vrf-fooo-booo exec -it <POD_NAME> sh

# show logs from pod
kubectl --context=k8s-workshop -n=vrf-fooo-booo logs -f --tail=20 -l=app=deploy-example
kubectl --context=k8s-workshop -n=vrf-fooo-booo logs -f --tail=20 <POD_NAME>
...
# get list of pods
kubectl --context=k8s-workshop -n=vrf-fooo-booo get pods 
# delete one pod
kubectl --context=k8s-workshop -n=vrf-fooo-booo delete pod <POD_NAME>
...
> `kubectl --context=k8s-workshop -n vrf-fooo-booo apply -f examples/service.yml`
```yaml
---
apiVersion: v1
kind: Service
...
kubectl --context=k8s-workshop -n=vrf-fooo-booo get services
...
```sh
# connnect to pod
kubectl --context=k8s-workshop -n=vrf-fooo-booo exec -it deployment/deploy-example -- bash
...
> `kubectl --context=k8s-workshop -n vrf-fooo-booo apply -f examples/ingress.yml`
```yaml
---
...
spec:
  ...
  rules:
  # https://vrf-fooo-booo.k8s.vrfgstest.org/
  - host: "vrf-fooo-booo.k8s.vrfgstest.org"
    http:
      paths:
      - pathType: Prefix
        path: "/"
...
And try to access your app using [https://vrf-fooo-booo.k8s.vrfgstest.org/](https://vrf-fooo-booo.k8s.vrfgstest.org/).

```sh
# get list of ingress
kubectl --context=k8s-workshop -n=vrf-fooo-booo get ingress
