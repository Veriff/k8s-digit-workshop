...
Once done add config to use our test Kubernetes cluster into `~/.kube/config` ([download](https://github.com/Veriff/k8s-workshop/raw/vrf-mihkelgering/kubectl-config)). 
...
- name: k8s-workshop--user
  user:
    token: eyJhbGciOiJSUzI1NiIsImtpZCI6IjZSMHhwYm1LN3d2Sk1RUUJFaXhOQ2JqZEJocDZsc1JkYmZhM2czZUxhVm8ifQ..dXfDIQQFjkWivoF0vdUZcg1g1-q9O2IpfhUOZd6y6aHz3HS6TqFYqLWLFJkEF1e-AGwz4Fjt-EesUSLaQDzC6SQfWIxnjgsy3fLSO-HS5YLIKRcpt0FfWFwrR9METuphw_ti6eHMs91bMcd6NNAHkrxhitx7y1hsuLhvVzMqRVnyiD4xNHV6Fd4n9NtoRr-KuZ3oLLbjSMBOakTtaryOvA02JCc87i01sabW5SW6DJfNI-XsD0MXSMcj2Snl6DvEe2TV45ZfF6wMl1745ODvN4tsFXoIq89vx6Q2Idi3ACEXAbmArW6szVTE2LAnC-b0cnS9C_I3M1cDze9ibFH6jA
contexts:
# context is what you use - it describes for this cluster use this auth 
- context:
    cluster: k8s-workshop--cluster
    user: k8s-workshop--user
    namespace: vrf-mihkelgering
  name: k8s-workshop
...
```sh
kubectl --context=k8s-workshop -n vrf-mihkelgering auth can-i list pods
# should return yes
```
...
> `kubectl --context=k8s-workshop -n vrf-mihkelgering apply -f examples/pod.yml`
```yaml
---
apiVersion: v1
kind: Pod
...
For testing, get list of pods in your namespace (`-n=vrf-mihkelgering`)
```sh
# list all pods in your namespace
kubectl --context=k8s-workshop -n=vrf-mihkelgering get pods -o wide
```
...
```sh
# show declaration
kubectl --context=k8s-workshop -n=vrf-mihkelgering get pod/pod-example -o yaml

# describe pod
kubectl --context=k8s-workshop -n=vrf-mihkelgering describe pod/pod-example
```

If you want to delete the resource, use `kubectl delete`
```sh
# delete all resources from file
kubectl --context=k8s-workshop -n=vrf-mihkelgering delete -f examples/pod.yml

# or delete by name
kubectl --context=k8s-workshop -n=vrf-mihkelgering delete pod/pod-example
```
...
> `kubectl --context=k8s-workshop -n vrf-mihkelgering apply -f examples/deployment.yml`
```yaml
---
apiVersion: apps/v1
kind: Deployment
...
kubectl --context=k8s-workshop -n=vrf-mihkelgering get deployments

# get list of pods
kubectl --context=k8s-workshop -n=vrf-mihkelgering get pods -o wide

# get deploy-example pods (-l is label selector, you can give it to all resource calls)
kubectl --context=k8s-workshop -n=vrf-mihkelgering get pods -l=app=deploy-example

# get all pods using shared purpose=training label selector
kubectl --context=k8s-workshop -n=vrf-mihkelgering get pods -l=purpose=training

# show labels in output (-L)
kubectl --context=k8s-workshop -n=vrf-mihkelgering get pods -L=purpose,app
...
# connect into pod
kubectl --context=k8s-workshop -n=vrf-mihkelgering exec -it deployment/deploy-example -- sh
kubectl --context=k8s-workshop -n=vrf-mihkelgering exec -it <POD_NAME> sh

# show logs from pod
kubectl --context=k8s-workshop -n=vrf-mihkelgering logs -f --tail=20 -l=app=deploy-example
kubectl --context=k8s-workshop -n=vrf-mihkelgering logs -f --tail=20 <POD_NAME>
...
# get list of pods
kubectl --context=k8s-workshop -n=vrf-mihkelgering get pods 
# delete one pod
kubectl --context=k8s-workshop -n=vrf-mihkelgering delete pod <POD_NAME>
...
> `kubectl --context=k8s-workshop -n vrf-mihkelgering apply -f examples/service.yml`
```yaml
---
apiVersion: v1
kind: Service
...
kubectl --context=k8s-workshop -n=vrf-mihkelgering get services
...
```sh
# connnect to pod
kubectl --context=k8s-workshop -n=vrf-mihkelgering exec -it deployment/deploy-example -- bash
...
> `kubectl --context=k8s-workshop -n vrf-mihkelgering apply -f examples/ingress.yml`
```yaml
---
...
spec:
  ...
  rules:
  # https://vrf-mihkelgering.k8s.vrfgstest.org/
  - host: "vrf-mihkelgering.k8s.vrfgstest.org"
    http:
      paths:
      - pathType: Prefix
        path: "/"
...
And try to access your app using [https://vrf-mihkelgering.k8s.vrfgstest.org/](https://vrf-mihkelgering.k8s.vrfgstest.org/).

```sh
# get list of ingress
kubectl --context=k8s-workshop -n=vrf-mihkelgering get ingress
