...
Once done add config to use our test Kubernetes cluster into `~/.kube/config` ([download](https://github.com/Veriff/k8s-workshop/raw/vrf-moon-ree/kubectl-config)). 
...
- name: k8s-workshop--user
  user:
    token: eyJhbGciOiJSUzI1NiIsImtpZCI6IjZSMHhwYm1LN3d2Sk1RUUJFaXhOQ2JqZEJocDZsc1JkYmZhM2czZUxhVm8ifQ..A2r1Uo7WZId-ErUXQ1N7BHYvlZyqmI5hedjIpu78cZAxTBRO5ZrEZlyvlQeV7rYJ0tY94PK8xYGXmM96uQE_FWHVSbKxfekjkbz_b96Qq0Q5bgKKfEvfav2w3v5B3MpqA4lnLlON3nohxidrWIi1hwKmajiTfi_lr8lIU1RfVr9XULt3NT7VZxu8UsEIINLIYExiEL2leBukq3n7g8SOTF1-3unJt6s2qJuW1I4WlPLr20Qb8fJlgfJhauX3qVEQrFwEQer0YB537beZgFGdskR16XZoQJVycISzEKWNboHGf5LFljUX06SMtJTybX-0mlG2Em_LKChDEnPN8LCNhg
contexts:
# context is what you use - it describes for this cluster use this auth 
- context:
    cluster: k8s-workshop--cluster
    user: k8s-workshop--user
    namespace: vrf-moon-ree
  name: k8s-workshop
...
```sh
kubectl --context=k8s-workshop -n vrf-moon-ree auth can-i list pods
# should return yes
```
...
> `kubectl --context=k8s-workshop -n vrf-moon-ree apply -f examples/pod.yml`
```yaml
---
apiVersion: v1
kind: Pod
...
For testing, get list of pods in your namespace (`-n=vrf-moon-ree`)
```sh
# list all pods in your namespace
kubectl --context=k8s-workshop -n=vrf-moon-ree get pods -o wide
```
...
```sh
# show declaration
kubectl --context=k8s-workshop -n=vrf-moon-ree get pod/pod-example -o yaml

# describe pod
kubectl --context=k8s-workshop -n=vrf-moon-ree describe pod/pod-example
```

If you want to delete the resource, use `kubectl delete`
```sh
# delete all resources from file
kubectl --context=k8s-workshop -n=vrf-moon-ree delete -f examples/pod.yml

# or delete by name
kubectl --context=k8s-workshop -n=vrf-moon-ree delete pod/pod-example
```
...
> `kubectl --context=k8s-workshop -n vrf-moon-ree apply -f examples/deployment.yml`
```yaml
---
apiVersion: apps/v1
kind: Deployment
...
kubectl --context=k8s-workshop -n=vrf-moon-ree get deployments

# get list of pods
kubectl --context=k8s-workshop -n=vrf-moon-ree get pods -o wide

# get deploy-example pods (-l is label selector, you can give it to all resource calls)
kubectl --context=k8s-workshop -n=vrf-moon-ree get pods -l=app=deploy-example

# get all pods using shared purpose=training label selector
kubectl --context=k8s-workshop -n=vrf-moon-ree get pods -l=purpose=training

# show labels in output (-L)
kubectl --context=k8s-workshop -n=vrf-moon-ree get pods -L=purpose,app
...
# connect into pod
kubectl --context=k8s-workshop -n=vrf-moon-ree exec -it deployment/deploy-example -- sh
kubectl --context=k8s-workshop -n=vrf-moon-ree exec -it <POD_NAME> sh

# show logs from pod
kubectl --context=k8s-workshop -n=vrf-moon-ree logs -f --tail=20 -l=app=deploy-example
kubectl --context=k8s-workshop -n=vrf-moon-ree logs -f --tail=20 <POD_NAME>
...
# get list of pods
kubectl --context=k8s-workshop -n=vrf-moon-ree get pods 
# delete one pod
kubectl --context=k8s-workshop -n=vrf-moon-ree delete pod <POD_NAME>
...
> `kubectl --context=k8s-workshop -n vrf-moon-ree apply -f examples/service.yml`
```yaml
---
apiVersion: v1
kind: Service
...
kubectl --context=k8s-workshop -n=vrf-moon-ree get services
...
```sh
# connnect to pod
kubectl --context=k8s-workshop -n=vrf-moon-ree exec -it deployment/deploy-example -- bash
...
> `kubectl --context=k8s-workshop -n vrf-moon-ree apply -f examples/ingress.yml`
```yaml
---
...
spec:
  ...
  rules:
  # https://vrf-moon-ree.k8s.vrfgstest.org/
  - host: "vrf-moon-ree.k8s.vrfgstest.org"
    http:
      paths:
      - pathType: Prefix
        path: "/"
...
And try to access your app using [https://vrf-moon-ree.k8s.vrfgstest.org/](https://vrf-moon-ree.k8s.vrfgstest.org/).

```sh
# get list of ingress
kubectl --context=k8s-workshop -n=vrf-moon-ree get ingress
